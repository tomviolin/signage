...
function updaterooms(everything, nextMove) {
	...
	$.getJSON("getdata.php?now="+thisNow+"&limitevents="+numevents, function(data) {
		...
		// build room lists
		var rlistml = "";
		rlistml += outputRooms(data.imminentrooms, 'Classes/Meetings Starting Soon<br><b><-- LOOK FOR MAP</b>','images/doorflash.gif', '#ddddff','#000000');
		rlistml += outputRooms(data.juststartedrooms, 'Classes/Meetings Just Started<br><b><-- LOOK FOR MAP</b>','images/doorclosedflash.gif','#ddddff','#000000');
...
<div data-role='page' id="page" style="background: rgba(0,0,0,0);">
	...
	<div id="content" data-role="content" style="background: rgba(0,0,0,0) !important;">
		...
		<div id="rotator" style="position:relative; top:0; left:0">
			<div class="rotating static short" style="position:absolute; top:0;left:0"><ul data-role="listview" data-inset="true" ><li data-role="list-divider" data-theme="b" style="font-size:150%">UWM Freshwater Webcam</li><li>The UWM School of Freshwater Sciences webcam records 24/7 images of the Inner Harbor of Milwaukee.  The background imagery on this display shows the most recent complete hour of images compressed into 30 seconds.<br><br><center><img src="phpqrcode/makeone.php?url=http://yt.vu/+freshwatercam&size=8"</center></li></ul></div> 
