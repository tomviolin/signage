...
function insertEvents($icsFile, $psource='') {
	...
	global $db;
	$sourceContent = file_get_contents($icsFile);
...
//if (!file_exists("/tmp/events.ical") || time() - filemtime("/tmp/events.ical") > 60*60*5) {
//	system("wget -qq -O /tmp/events.ical 'http://uwm.edu/freshwater/events/?ical=1' >/dev/null");
//}
//insertEvents("/tmp/events.ical");
//insertEvents("http://localhost/signage/sfscal.php");
