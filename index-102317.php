...
function outputMap(room) {
	...
	mapml = '<div class="rotating map" style="opacity:0"><ul data-role="listview" data-inset="true" style="width:<?= $MAPWIDTH ?>px; float:left; margin-right: 0.5%; background: white">\n'
